...
class AchievementsMainButton(discord.ui.Button):
    def __init__(self, view):
        super().__init__(
            label="Main", style=discord.ButtonStyle.primary, emoji="🏠", row=0
        )
...
class AchievementsCategoryButton(discord.ui.Button):
    def __init__(self, view):
        super().__init__(
            label="Category", style=discord.ButtonStyle.green, emoji="📂", row=0
        )
        self.parent_view = view
...
class AchievementsLeaderboardButton(discord.ui.Button):
    def __init__(self, view):
        super().__init__(
            label="Leaderboard", style=discord.ButtonStyle.blurple, emoji="🏆", row=0
        )
        self.parent_view = view
